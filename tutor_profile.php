...
<!-- Секция профиля преподавателя начинается -->
...
<section class="tutor-profile">
   ...
   <div class="details">
      ...
      <div class="flex">
         <p>Всего плейлистов: <span><?= $total_playlists; ?></span></p>
...
<!-- Секция профиля преподавателя заканчивается -->

<section class="courses">

   <h1 class="heading">Последние курсы</h1>
   ...
   <div class="box-container">
      ...
      <?php
         ...
         echo '<p class="empty">Пока нет добавленных курсов!</p>';
      }
      ?>
