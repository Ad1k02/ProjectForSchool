...
<section class="teachers">
   ...
   <form action="search_tutor.php" method="post" class="search-tutor">
      <input type="text" name="search_tutor" maxlength="100" placeholder="Поиск преподавателя..." required>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Всего видео : <span><?= $total_contents ?></span></p>
         <p>Всего лайков : <span><?= $total_likes ?></span></p>
         <p>Всего комментариев : <span><?= $total_comments ?></span></p>
         <form action="tutor_profile.php" method="post">
            <input type="hidden" name="tutor_email" value="<?= $fetch_tutor['email']; ?>">
            <input type="submit" value="Просмотреть профиль" name="tutor_fetch" class="inline-btn">
         </form>
      </div>
      <?php
            }
         }else{
            echo '<p class="empty">Преподаватели не найдены!</p>';
         }
      ?>
