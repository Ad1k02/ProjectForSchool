...
name" placeholder="<?= $fetch_profile['name']; ?>" maxlength="100" class="box">
         ...
         <div class="col">
               <p>Старый пароль</p>
               <input type="password" name="old_pass" placeholder="Введите старый пароль" maxlength="50" class="box">
               <p>Новый пароль</p>
               <input type="password" name="new_pass" placeholder="Введите новый пароль" maxlength="50" class="box">
               <p>Подтвердите пароль</p>
               <input type="password" name="cpass" placeholder="Подтвердите новый пароль" maxlength="50" class="box">
         </div>
      </div>
      <input type="submit" name="submit" value="Обновить профиль" class="btn">
   </form>

</section>

<!-- Конец раздела обновления профиля -->
