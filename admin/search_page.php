...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">просмотреть контент</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">нет контента!</p>';
      }
   }else{
      echo '<p class="empty">пожалуйста, что-нибудь найдите!</p>';
   }
   ?>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">обновить</a>
            <input type="submit" value="удалить" class="delete-btn" onclick="return confirm('удалить этот плейлист?');" name="delete">
         </form>
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">просмотреть плейлист</a>
      </div>
      <?php
         } 
      }else{
         echo '<p class="empty">плейлисты не найдены!</p>';
      }}else{
         echo '<p class="empty">пожалуйста, что-нибудь найдите!</p>';
      }
      ?>
