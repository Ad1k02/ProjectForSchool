...
<section class="playlists">
   ...
   <h1 class="heading">Добавленные плейлисты</h1>

   <div class="box-container">
   
      <div class="box" style="text-align: center;">
         <h3 class="title" style="margin-bottom: .5rem;">Создать новый плейлист</h3>
         <a href="add_playlist.php" class="btn">Добавить плейлист</a>
      </div>
      ...
      <div class="box">
         ...
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">Просмотр плейлиста</a>
      </div>
      <?php
         } 
      }else{
