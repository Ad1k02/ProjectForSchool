...
<!-- Секция обновления профиля начинается -->
...
<section class="form-container" style="min-height: calc(100vh - 19rem);">
   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="col">
            <p>старый пароль :</p>
            <input type="password" name="old_pass" placeholder="введите ваш старый пароль" maxlength="20" class="box">
            <p>новый пароль :</p>
            <input type="password" name="new_pass" placeholder="введите ваш новый пароль" maxlength="20" class="box">
            <p>подтвердите пароль :</p>
            <input type="password" name="cpass" placeholder="подтвердите ваш новый пароль" maxlength="20" class="box">
         </div>
      </div>
      <p>обновить фото :</p>
      <input type="file" name="image" accept="image/*" class="box">
      <input type="submit" name="submit" value="обновить сейчас" class="btn">
   </form>
