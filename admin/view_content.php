...
<section class="view-content">
   ...
   <div class="container">
      ...
      <form action="" method="post">
         <div class="flex-btn">
            ...
            <a href="update_content.php?get_id=<?= $video_id; ?>" class="option-btn">Изменить</a>
   ...
   <?php
      ...
      echo '<p class="empty">Контент еще не добавлен! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Добавить видео</a></p>';
   }
