...
<section class="contents">
   ...
   <h1 class="heading">Ваши материалы</h1>

   <div class="box-container">

   <div class="box" style="text-align: center;">
      <h3 class="title" style="margin-bottom: .5rem;">Создать новый материал</h3>
      <a href="add_content.php" class="btn">Добавить материал</a>
   </div>
   ...
   ?>
      <div class="box">
         ...
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">Просмотреть материал</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">Материалы еще не добавлены!</p>';
      }
   ?>
