...
<section class="courses">
   ...
   <h1 class="heading">Закладки на плейлисты</h1>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="playlist.php?get_id=<?= $course_id; ?>" class="inline-btn">Посмотреть плейлист</a>
      </div>
      <?php
               }
            }else{
         ...
         echo '<p class="empty">Пока ничего не добавлено в закладки!</p>';
      }
      ?>
